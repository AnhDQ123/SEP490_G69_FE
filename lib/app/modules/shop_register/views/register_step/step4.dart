      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            buildTextField(controller.idCard, label: "Số CCCD/CMND/Hộ chiếu", isRequired: true),
            ...
            buildTextField(controller.taxCode, label: "Mã số thuế", isRequired: true),
              ...
              children: [
                Expanded(
                  child: buildImageUploader(
                    ...
                    isLicense: true, isRequired: true
                  ),
                ),
                SizedBox(width: 12),
                Expanded(
            ...
            buildTextField(controller.bankInfo, label: "Số tài khoản ngân hàng", isRequired: true),
            SizedBox(height: 20),
          ],
        ),
      ),
