...
class CartView extends StatelessWidget {
  ...
  Widget _buildCartItem(BuildContext parentContext, int shopId, CartItem item) {
    ...
    return Obx(() {
      ...
      List<CartItemOption> selectedFoodOptions =
      item.cartItemOptionDTOList.where((opt) => opt.typeId == 3).toList();
  ...
  void _showSizeBottomSheet(BuildContext context, List<CartItemOption> sizes,
  ...
  void _showFoodOptionBottomSheet(BuildContext context, List<CartItemOption> options, int shopId, int productId) {
    showModalBottomSheet(
      context: context,
      builder: (BuildContext context) {
        return Padding(
            ...
            children: [
              ...
              Column(
                children: options.map((option) {
                  return ListTile(
                    title: Text(option.optionName, style: const TextStyle(fontSize: 16)),
